...
RESPUESTAS_DATA = {
    ...
    "desconocido": [
        "Lo siento, aún no sé cómo responder a eso. Solo manejo temas de Salud Lince (citas, expedientes o contraseñas).",
    ...
    "cambiar_password": ["Inicia sesión, ve a 'Mi Perfil' y en la derecha verás la opción de actualizar clave."],
    "ver_historial": ["Tu historial médico está en la pestaña 'Historial médico'."],
    "ver_consultas": ["Consulta tus citas en el apartado 'Mis Consultas'."],
    "agregar_contacto": ["Añade contactos de emergencia en la sección 'Mi Perfil'."],
    "iniciar_sesion": ["Ingresa con tu matrícula/número de trabajador y tu clave institucional."],
